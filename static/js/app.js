// #1 create from challenge starter file
...
function updateFilters() {
  ...
  let updatedEntry = d3.select(this);
    
  // 4b. Save the value that was changed as a variable.
  let entry = updatedEntry.property("value");
  console.log(entry);

  // 4c. Save the id of the filter that was changed as a variable.
  let filterId = updatedEntry.attr("id");
